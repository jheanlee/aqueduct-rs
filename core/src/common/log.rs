...
fn get_config(stdout_filter: u8, system_filter: u8, stdout_enabled: bool, system_logging_enabled: bool) -> LogConfig {
  LogConfig {
    stdout_filter,
    system_filter,
    stdout_enabled,
...
pub fn init(verbose_level: u8, system_filter: u8, stdout_enabled: bool, system_logging_enabled: bool) -> Result<LogConfig, Error> {
  if cfg!(target_os = "macos") {
    ...
    Ok(get_config(stdout_filter, system_filter, stdout_enabled, system_logging_enabled))
